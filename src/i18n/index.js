...
export const translations = {
  ru: {
    ...
    // Random Picker modal
    'random.eyebrow':             'Рандом',
    'random.title':               'Что хочешь посмотреть?',
    'random.type_label':          'Тип',
    'random.type_any':            'Неважно',
    'random.type_movie':          'Фильм',
    'random.type_series':         'Дорама',
    'random.genre_label':         'Жанр',
    'random.genre_random':        'Случайный',
    'random.loading':             'Загружаем…',
    'random.no_genres':           'Пока нет жанров — добавь что-нибудь в список',
    'random.pick_btn':            'Выбрать',
    'random.spinning':            'Подбираем что-то хорошее…',
    'random.status_label':        'Статус',
    'random.country_label':       'Страна',
    'random.reroll_btn':          'Ещё раз',
    'random.open_btn':            'Открыть',
    'random.edit_filters':        'Изменить фильтры',
    'random.empty_title':         'Тут пока пусто',
    'random.empty_sub':           'По фильтру «{type} + {genre}» ничего не нашлось в твоей библиотеке',
    'header.tooltip.random':      'Случайный выбор',
    'header.tooltip.random_empty':'Добавь что-нибудь в «Запланировано», чтобы рандомить',
  ...
  en: {
    ...
    // Random Picker modal
    'random.eyebrow':             'Random',
    'random.title':               'What do you want to watch?',
    'random.type_label':          'Type',
    'random.type_any':            'Any',
    'random.type_movie':          'Movie',
    'random.type_series':         'Drama',
    'random.genre_label':         'Genre',
    'random.genre_random':        'Random',
    'random.loading':             'Loading…',
    'random.no_genres':           'No genres yet — add something to your list',
    'random.pick_btn':            'Pick',
    'random.spinning':            'Finding something good…',
    'random.status_label':        'Status',
    'random.country_label':       'Country',
    'random.reroll_btn':          'Reroll',
    'random.open_btn':            'Open',
    'random.edit_filters':        'Edit filters',
    'random.empty_title':         'Nothing here yet',
    'random.empty_sub':           'No matches for «{type} + {genre}» in your library',
    'header.tooltip.random':      'Random pick',
    'header.tooltip.random_empty':'Add something to «Plan to watch» to enable random pick',
